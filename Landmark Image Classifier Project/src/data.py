...
def get_data_loaders(
    ...
    # "pin_memory": True, 
    # "pin_memory_device": 'cuda:0'if torch.cuda.is_available() else 'cpu', 
    # "prefetch_factor": 4
    # }
    ...
    data_loaders["train"] = torch.utils.data.DataLoader(
        ...
        **gpu_kwargs # Extra keyword arguments are passed to the dataloaders. For example: GPU optimizations.
    )
